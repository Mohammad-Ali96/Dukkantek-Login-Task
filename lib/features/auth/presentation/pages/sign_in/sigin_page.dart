import 'package:dukkantek_task/core/presentation/blocs/auth/auth_bloc.dart';
import 'package:dukkantek_task/core/presentation/utils/validation_util.dart';
import 'package:dukkantek_task/core/presentation/widgets/custom_password_text_field.dart';
import 'package:dukkantek_task/core/presentation/widgets/custom_text_field.dart';
import 'package:dukkantek_task/core/presentation/widgets/screen_loader.dart';
import 'package:dukkantek_task/core/presentation/widgets/screen_utils.dart';
import 'package:dukkantek_task/features/auth/domain/usecases/sign_in_with_email_use_case.dart';
import 'package:dukkantek_task/features/auth/presentation/blocs/sign_in_with_email/sign_in_with_email_bloc.dart';
import 'package:dukkantek_task/features/auth/presentation/blocs/sign_in_with_google/sign_in_with_google_bloc.dart';
import 'package:dukkantek_task/gen/assets.gen.dart';
import 'package:dukkantek_task/injection.dart';
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: () {
                          ...
                          signInBloc.add(SignInOnSubmit(SignInWithEmailUseCaseParams(
